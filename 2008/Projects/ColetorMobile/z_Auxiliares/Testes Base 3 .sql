...
WHERE propostaPICKINGMOBILE = 80396  AND codigoPICKINGMOBILE = 18
				...
				UPDATE tb1651_Picking_Mobile
				SET statusPIcKINGMOBILE = 0
                WHERE codigoPICKINGMOBILE = 1067
...
,codigoPRODUTO, partnumberPRODUTO, nomePRODUTO, quantidadeEMBALAGEMPRODUTO,ean13PRODUTO
,codigoEMBALAGEM,nomeEMBALAGEM,produtoEMBALAGEM,pesoEMBALAGEM,padraoEMBALAGEM
FROM tb0501_Produtos
INNER JOIN tb0504_Embalagens_Produtos ON codigoPRODUTO = produtoEMBALAGEMPRODUTO
LEFT JOIN tb0545_Embalagens ON produtoEMBALAGEM = codigoPRODUTO
WHERE produtoEMBALAGEMPRODUTO IN(9869)
